        ...
        <div style="background-color: white">
            ...
            <div class="pour-box">
                <div class="pour-ques">
                    ...
                    <div class="ques-text">
                        <div v-for="(ques,index) in pour.hot" :key="index.question" class="ques-text-txt">
                            ...
                            <div style="display:flex;height: 68px;justify-content: space-between;margin: auto 10px">
                                <div style="width: 85%;">
                                    <suspense>
                                        <Criterion :id=ques.pour_id type="index" />
                                    </suspense>
                                </div>
                ...
                <div class="pour-hot">
                    ...
                    <hr>
                    <div class="hot-text">
                        <div v-for="(news,index) in pour.new"  :key="index.new" class="hot-text-child">
