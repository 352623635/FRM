        ...
        <div style="padding-top: 10px">
                ...
                <div v-else style="width: 100%;">
                    <router-link to="/add_mood">
                        <div style="max-width: 1000px;min-width: 750px;margin: auto">
                            <el-image style="width: 100%;height: 100%" :src="'http://localhost:3001/none_mood.png'+''"></el-image>
                        </div>
                    </router-link>
                </div>
            </div>
            <div v-else style="width: 100%;">
                <router-link to="/login">
                    <div style="max-width: 1000px;min-width: 750px;margin: auto">
                        <el-image style="width: 100%;height: 100%" :src="'http://localhost:3001/not_login_mood.png'+''"></el-image>
                    </div>
                </router-link>
            </div>
        </div>
